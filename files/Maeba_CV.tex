...
\section{Publication}
\begin{list1}
\item[] ``How the Political Power of Teacher Unions Affects Education'' (joint with Eduardo Campillo Betancourt), {\it Education Economics}, Forthcoming
\end{list1}


\section{Working Papers}
\begin{list1}
\item[] ``Extrapolation of Treatment Effect Estimates Across Contexts and Policies: An Application to Cash Transfer Experiments,'' {\it Available at \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4863355}{SSRN} (Job Market Paper)}, March 2024
...
\item[] ``Birth Order Effect Under a Cash Transfer Program,'' {\it Available at \href{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3010113}{SSRN} (Pre-doctoral thesis)}, July 2019
\end{list1}
